...
**État : contrôle de chargement et de consigne en jeu en attente de l’utilisateur.** Le cycle de chiffrement vérifié ne prouve ni que le jeu accepte le fichier, ni qu’il utilise ces instructions pendant un match. La réduction des longs ballons, les autres consignes et formations, l’application sans rechargement et le format ML restent à valider. L’utilisateur testera après sa partie sur un autre jeu.
...
16 tests Python passent pour l’adaptateur et cette simulation, dont 25 saisons avec **749 clubs et 980 entraîneurs initiaux entièrement fictifs**, sans coach retraité en poste ni double affectation. Cela valide les invariants du code ; aucune carrière FL n’a encore subi 25 saisons de cette simulation. Le calendrier interne, les résultats de toutes les équipes, le rattachement persistant aux sauvegardes et l’écriture des changements de coach dans le jeu restent nécessaires avant activation. Aucun coach de la carrière utilisateur n’a été remplacé.
